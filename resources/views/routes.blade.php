...
@section('content')
    @php
        ...
        $canAdd = in_array('routes_add', $roleArray) || in_array('All', $roleArray);
        $canEdit = in_array('routes_edit', $roleArray) || in_array('All', $roleArray);
        $canDelete = in_array('routes_delete', $roleArray) || in_array('All', $roleArray);
    @endphp

            ...
            <li>
                ...
                <div id="pharmacyMaster" class="collapse 
                    ...
                    <ul class="sb_submenu">
                        ...
                        <!-- Product Management -->
                        @if(in_array('medicine', $roleArray) || in_array('inventory', $roleArray) || in_array('All', $roleArray))
                            <li class="submenu-title divider">Product Management</li>
                            @if(in_array('medicine', $roleArray) || in_array('All', $roleArray))
            ...
            <li>
                ...
                <div id="userManagement" class="collapse 
                    ...
                    <ul class="sb_submenu">
                        ...
                        <!-- Pharmacy Accounts -->
                        <li>
                            <a href="/admin/users/pharmacy-accounts">
                                <i class="bx bx-capsule"></i> <!-- Icon for pharmacy accounts -->
                                <span>Pharmacy Accounts</span> <!-- Clearer label -->
                            </a>
                        </li>
                    </ul>
                </div>

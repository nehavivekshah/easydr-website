    ...
    <ul class="nav-list" id="accordion">
        ...
        <li>
            ...
            <div id="patientManagement" class="collapse 
                @if(in_array(Request::segment(2), [
                    ...
                    'patient-reports', 
                    'patient-statistics'
                ]) || Request::segment(3) == 'patient-directory') show @endif" 
                data-bs-parent="#accordion">
        ...
        <li>
            ...
            <div id="doctorManagement" class="collapse 
                @if(in_array(Request::segment(2), [
                    ...
                    'revenue-reports',
                    'patient-statistics'
                ]) || Request::segment(3) == 'doctor-directory') show @endif" 
                data-bs-parent="#accordion">
        ...
        <li class="profile">
            <div class="profile_details">
                <img src="{{ asset('public/assets/images/profiles/'.(Auth::user()->photo ?? "")) }}" alt="profile image">

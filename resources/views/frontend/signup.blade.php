...
<main>
    <!-- signup-area -->
    <section id="signup" class="team-area pt-50 pb-40">
        <div class="container">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="/signup" onsubmit="return validatePasswords()">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="first_name" name="first_name" required placeholder="Enter first name" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="mobile" name="mobile" required placeholder="Enter mobile number" required>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary top-btn mb-3 rounded">Register</button>

            ...
            <div class="row align-items-center">                                            
                <div class="col-lg-6 col-md-8 d-none  d-md-block">
                    <div class="header-cta">
                        <ul>
                            <li>
                                <a href="https://apps.apple.com/in/app/" target="_blank"><i class="fab fa-apple"></i></a>
                                <a href="https://play.google.com/store/apps/details?id=com.easy.doctor" target="_blank"><i class="fab fa-android"></i></a>
                    ...
                    <div class="col-xl-8 col-lg-8">                               
                     ...
                     <div class="col-xl-2 col-lg-2 d-none d-lg-block text-center">
                        ...
                        <div class="main-menu text-right">
                            <ul>
                                <li class="has-sub">
                                    <a href="javascript:void(0)"><span  class="top-btn"><i class="fas fa-user pr-1"></i> {{Auth::User()->first_name}}</span></a>
                                    <ul class="has-right">
                                        <li><a href="/my-account"><i class="fas fa-user pr-1"></i> My Account</a></li>
                                        <li><a href="/reset-posswprd"><i class="fas fa-key pr-1"></i> Reset Password</a></li>
                                        <li><a href="/logout"><i class="fas fa-sign-out-alt pr-2"></i>Logout</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>

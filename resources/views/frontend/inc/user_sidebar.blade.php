@if(Auth::check())
    ...
    <ul class="dashboard_menu">
        @if(Auth::user()->role == 5)
            ...
            <li><a class="{{ Request::is('medical-reports*') ? 'active' : '' }}" href="/medical-reports">Medical Reports</a>
            </li>
            <li><a class="{{ Request::is('patient-prescriptions*') ? 'active' : '' }}"
                    href="/patient-prescriptions">Prescriptions</a></li>

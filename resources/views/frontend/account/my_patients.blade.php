                    ...
                    <div class="tab-pane fade modal-body" id="tab-refer">
                        <form id="referralForm">
                            <div class="mb-3">
                                ...
                                <select class="form-select w-100 rounded-3 p-3" id="refer-specialist">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select w-100 rounded-3 p-3" id="refer-doctor">
                    ...
                    <div class="tab-pane fade modal-body" id="tab-add-prescription">
                        <form id="prescriptionForm" class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select w-100 rounded-3 p-3" id="presc-dosage" required>
                                    <option value="">Select Dosage</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold small text-uppercase">Frequency</label>
                                <select class="form-select w-100 rounded-3 p-3" id="presc-frequency" required>
                                    <option value="">Select Frequency</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold small text-uppercase">Duration</label>
                                <select class="form-select w-100 rounded-3 p-3" id="presc-duration" required>
                                    <option value="">Select Duration</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold small text-uppercase">Route</label>
                                <select class="form-select w-100 rounded-3 p-3" id="presc-route">
                                    <option value="">Select Route</option>
                                </select>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label fw-bold small text-uppercase">Food Intake (Meal)</label>
                                <select class="form-select w-100 rounded-3 p-3" id="presc-meal">

...
@section('content')
    ...
    <main>
        ...
        <section id="services" class="services-area services-bg services-two pt-100 pb-70"
            style="background-image:url(public/assets/frontend/img/bg/services_aliment_bg.html); background-size: contain; background-repeat: no-repeat;background-position: center center;">
            <div class="container">
        ...
        <section class="faq-area pt-50 pb-50 fix"
            style="background-image: url(public/assets/frontend/img/shape/header-sape6.html); background-position: right center; background-size: auto;background-repeat: no-repeat;">
            <div class="container">
                <div class="row align-items-end">

                        ...
                        <div class="col-md-8">
                            <div class="card border-0 shadow-sm rounded-4">
                                <div class="card-header bg-white border-bottom-0 pt-4 pb-0 text-center">
                                    ...
                                    <p class="text-muted small">Choose how you would like to pay for your appointment with
                                        Dr. {{ $doctor_name }}</p>
                                </div>
                                <div class="card-body p-4">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    @else
                                                        <i class="fas fa-wallet fa-2x text-secondary me-3"
                                                            style="width: 40px; text-align: center;"></i>
                                                        <div class="text-start">
                                                            <h6 class="mb-0 fw-bold">{{ ucfirst($gateway->gateway_name) }}</h6>
                                    ...
                                    <div class="text-center mt-4">
                                        <a href="{{ url('/my-account') }}" class="text-muted text-decoration-none small">
                                            <i class="fas fa-arrow-left me-1"></i> Cancel and return to dashboard
                                        </a>
                                    </div>

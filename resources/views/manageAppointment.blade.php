                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" id="doctor_id" name="doctor_id" required>
                                                ...
                                                @foreach($doctors as $doctor)
                                                    <option value="{{ $doctor->id }}" @if(($appointments->did ?? '') == ($doctor->id ?? '')) selected @endif>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" id="appointment_time" name="appointment_time"
                                                ...
                                                @if(!empty($appointments->time))
                                                    <option
                                                        class="{{date_format(date_create($appointments->time ?? null), 'H:i')}}"
                                                        selected>
                                                        {{date_format(date_create($appointments->time ?? null), 'h:i A')}}
                                                    </option>
                                                @endif
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" id="payment_status" name="payment_status">
                                                ...
                                                <option value="paid" @if(($appointments->payment_status ?? '') == 'paid')

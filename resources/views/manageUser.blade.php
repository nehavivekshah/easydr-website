...
@section('content')
    <section class="task__section">
        <div class="d-flex align-items-center gap-3 mb-4">
            @if(!$isProfile)
                <a href="/admin/users/{{$type ?? ''}}" class="btn btn-default btn-sm">
                            ...
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        @if(!empty($users->photo)) <img
                                            src="/public/assets/images/profiles/{{ $users->photo }}" class="media-icon">
                                        @endif
                                ...
                                @if($isPatient)
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class='bx bx-upload'></i></span>
                                            @if(!empty($users->health_card_file)) <img
                                                src="/public/assets/images/healthCards/{{ $users->health_card_file }}"
                                            class="media-icon"> @endif
                                            <input type="file" class="form-control" name="health_card_file" accept="image/*">
                                        </div>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>Upload (Medical File): Jpg, jpeg, Png</label>
                                        <div class="input-group">
                                            <span class="input-group-text"><i class='bx bx-upload'></i></span>
                                            @if(!empty($users->medical_file)) <img
                                                src="/public/assets/images/medicals/{{ $users->medical_file }}"
                                            class="media-icon"> @endif
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="adhar"
                                            placeholder="Enter Adhar Card No." value="{{ $users->adhar ?? '' }}"
                                            maxlength="12">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="specialization"
                                                placeholder="Enter Specialization*" value="{{ $users->specialist ?? '' }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="education"
                                                placeholder="Enter Education*" value="{{ $users->education ?? '' }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="license"
                                                placeholder="Enter Medical License Number*" value="{{ $users->license ?? '' }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-12 form-group">
                                        <label>About</label>
                                        <textarea class="form-control border" name="about" placeholder="Write Here..."
                                            rows="2">{{ $users->about ?? '' }}</textarea>
                                    </div>
                                @endif
                            </div>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="designation"
                                            placeholder="Enter Designation" value="{{ $users->designation ?? '' }}">
                                    </div>
                                </div>

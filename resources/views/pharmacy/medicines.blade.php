        ...
        <div class="text">
            ...
            @if(in_array('medicine_add', $roleArray) || in_array('All', $roleArray))
                <div class="btn-group m-0">
                    <a href="/admin/manage-medicine" class="btn btn-default btn-sm"><i class="bx bx-plus"></i> <span>Add
                            New</span></a>
                </div>
            @endif
        </div>
                        ...
                        <tbody>
                            @foreach($medicines as $medicine)
                                <tr>
                                    ...
                                    <td class="text-center">@if($medicine->available == '1')<span
                                    class="btn btn-success btn-sm">Available</span>@else<span
                                            class="btn btn-danger btn-sm">Not Available</span>@endif</td>
                                    <td class="text-center">
                                        @if(in_array('medicine_edit', $roleArray) || in_array('All', $roleArray))
                                            <a href="/admin/manage-medicine?id={{ $medicine->id }}" class="btn btn-info btn-sm"

...
@section('content')
    ...
    <section class="task__section">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h2 class="mb-0 text-dark fw-bold" style="font-size: 1.5rem;">{{ $pagename ?? '' }}</h2>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                @endif
                <button class="btn btn-outline-secondary rounded-pill shadow-sm px-4" title="Export to PDF">

@extends('layout')
@section('title', "$pagename - Easy Doctor")
                    ...
                    <table id="lists" class="table table-striped table-bordered m-table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $appointment->famdoctor_first_name ?? $no_doc }} {{ $appointment->famdoctor_last_name ?? '' }}
                                </td>
                                <td>
                                ...
                                <td>
                                    {{ $appointment->doctor_first_name ?? '--' }} {{ $appointment->doctor_last_name ?? '' }}<br><span class="text-danger small">({{ $appointment->specialist ?? '' }})</span>
                                </td>
                                @endif
                                
                                <td>
                                    {{ !empty($appointment->date) ? \Carbon\Carbon::createFromFormat('Y-m-d', $appointment->date)->format('d M, Y') : '--' }} <span class="text-primary">-</span> 
                                ...
                                <td class="text-center">
                                    ...
                                    @if(in_array('permission_delete', $roleArray) || in_array('All', $roleArray))
                                        <form action="/admin/cancel-appointment/{{ $appointment->id }}" 
                                              method="POST" 

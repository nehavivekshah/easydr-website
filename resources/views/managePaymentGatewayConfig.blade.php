    ...
    <section class="task__section">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="page-header-title">{{ $isEdit ? 'Edit Payment Gateway' : 'Add New Payment Gateway' }}</h4>
                    <nav aria-label="breadcrumb" class="mt-1">
                        <ol class="breadcrumb mb-0" style="font-size:.8rem;">
                            <li class="breadcrumb-item"><a href="/admin/dashboard"
                                    class="text-decoration-none text-muted">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="/admin/payment-gateway-configs"
                                    class="text-decoration-none text-muted">Payment Gateways</a></li>
            ...
            <div class="wizard-card">
                <div class="wizard-banner">
                    <a href="/admin/payment-gateway-configs" class="wizard-back-btn" title="Back"><i
                            class="bx bx-arrow-back"></i></a>
                    <div class="wizard-banner-icon"><i class="bx bx-credit-card"></i></div>
                    <div>
                        <p class="wizard-banner-title">{{ $isEdit ? 'Edit Payment Gateway' : 'Add New Payment Gateway' }}
                        </p>
                        <p class="wizard-banner-sub">Set up gateway identity and API credentials across 2 steps</p>
                    </div>
                </div>
                <div class="wizard-card-body">
                    ...
                    <form action="/admin/manage-payment-gateway-config" method="POST" enctype="multipart/form-data"
                        id="pgcForm">
                        @csrf
                        ...
                        <div class="wizard-panel active" id="step-1">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label small fw-semibold">Gateway Name <span
                                ...
                                <div class="col-md-6">
                                    <label class="form-label small fw-semibold">Merchant ID <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="bx bx-barcode"></i></span>
                                        <input type="text" name="merchant_id" class="form-control"
                                            placeholder="Enter Merchant ID" value="{{ $pgc->merchant_id ?? '' }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label small fw-semibold">Environment <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                        ...
                        <div class="wizard-panel" id="step-2">
                            ...
                            <div class="security-note mb-4">
                                ...
                                <span>API keys and secrets are sensitive. Ensure you are copying these from your gateway
                                    dashboard directly. They will be securely stored.</span>
                            </div>

                            <div class="row g-3">
                                <div class="col-md-12">
                                    <label class="form-label small fw-semibold">API Key <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group secret-wrap">
                                        <span class="input-group-text"><i class="bx bx-key"></i></span>
                                        <input type="password" name="api_key" id="api_key" class="form-control pe-5"
                                            placeholder="Enter API Key" value="{{ $pgc->api_key ?? '' }}" required>
                                        <i class="bx bx-hide secret-toggle" data-target="api_key"></i>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label small fw-semibold">API Secret <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group secret-wrap">
                                        <span class="input-group-text"><i class="bx bx-lock-alt"></i></span>
                                        <input type="password" name="api_secret" id="api_secret" class="form-control pe-5"
                                            placeholder="Enter API Secret" value="{{ $pgc->api_secret ?? '' }}" required>

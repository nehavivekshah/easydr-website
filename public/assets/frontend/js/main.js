...
$('.team-active').slick({
	...
	infinite: true,
	arrows: true,
    prevArrow: '<button type="button" class="slick-prev"><img src="/public/assets/frontend/img/bg/left-arrow.png"/></button>',
	nextArrow: '<button type="button" class="slick-next"><img src="/public/assets/frontend/img/bg/right-arrow.png"/></button>',
	speed: 1000,
	slidesToShow: 3,
	slidesToScroll: 1,
	responsive: [
